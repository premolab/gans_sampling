...
def get_fc_gan_parser():
    ...
    parser.add_argument('--n_layers_d', type=int, default=2) #1) #params_module.n_layers_d)
    ...
    parser.add_argument('--k_d', type=int, default=10)#3) #5) #10)
    parser.add_argument('--k_g', type=int, default=1)
    parser.add_argument('--loss_type', type=str, choices=['Jensen_minimax', 'Jensen_nonsaturing'], default='Jensen_nonsaturing')#'Jensen_minimax')
