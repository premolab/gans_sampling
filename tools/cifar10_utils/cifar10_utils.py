   ...
   for i in range(num_steps):
      ...
      (inception_score_mean, 
         inception_score_std) = inception_score(latent_dataset, 
                                               device, 
                                               batch_size, True)
      print(f"{method_name} mean inception score = {inception_score_mean}, std inception score = {inception_score_std}")
      ...
      print(f"FID score for test CIFAR10 with {method_name}: mean {mean_fid_test}, score {std_fid_test}")
      end = round(time.time() - start, 3)
      ...
      print(f"FID score for train CIFAR10 with {method_name}: mean {mean_fid_train}, score {std_fid_train}")
...
def plot_scores_cifar10_dynamics(scores,
